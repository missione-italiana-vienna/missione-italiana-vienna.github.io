      ...
      for (i = 0; i < events.length; ++i) {
        ...
        if (input_string == "future") {
          ...
          if (date_considered >= comparison_date) {
            if (date_considered <= last_date_to_consider) {
              ...
              break; // we can skip analyzing future events far in the future
            }
          }
          // NOTE: no else for the if (date_considered >= comparison_date) since
          // this would be the case of dates in the past: we still have to analyze the dates in the future
        } else {
          ...
          if (date_considered < comparison_date) {
            ...
            break; // we can skip analyzing events after comparison_date since we are
            // in the case input_string == "past_current_year" or input_string == "past_previous_year"
          }
        }
      }
